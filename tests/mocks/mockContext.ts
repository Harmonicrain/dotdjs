...
export const createMockContext = (overrides: Partial<GameStateData> = {}) => {
    ...
    return {
        ...
        setHealth: vi.fn(),
        setPoints: vi.fn(),
        setTotalEarnedPoints: vi.fn(),
        setKills: vi.fn(),
        setShotsFired: vi.fn(),
        setRound: vi.fn(),
        setIsGameOver: vi.fn(),
        setIsDowned: vi.fn(),
        setIsSpectating: vi.fn(),
        setFlashColor: vi.fn(),
        setHoverMsg: vi.fn(),
        setReviveProgress: vi.fn(),
        setShowRoundIntro: vi.fn(),
        setTotalRoundZombies: vi.fn(),
        setActiveZombiesCount: vi.fn(),
        ui: {
            setZombiesSpawned: vi.fn(),
            setZombiesKilledInRound: vi.fn(),
            setZombiesToSpawn: vi.fn(),
            setDebugInfo: vi.fn(),
        },
        visualManager: {
